...
export const linkIntStyles: Record<BaseColors, string> = {
  ...
  danger: 'hover:text-danger-700 focus:text-danger-700 active:text-danger-800 visited:text-danger-500',
  warning: 'hover:text-warning-600 focus:text-warning-600 active:text-warning-700 visited:text-warning-400',
  info: 'hover:text-primary-500 focus:text-primary-500 active:text-primary-600 visited:text-primary-300',
  light: 'hover:text-tertiary-300 focus:text-tertiary-300 active:text-tertiary-400 visited:text-tertiary-100',
...
export const mainElIntStyles: Record<BaseColors, string> = {
  ...
  danger: 'hover:bg-danger-700 focus:bg-danger-700 active:bg-danger-800',
  warning: 'hover:bg-warning-600 focus:bg-warning-600 active:bg-warning-700',
  info: 'hover:bg-primary-500 focus:bg-primary-500 active:bg-primary-600',
  light: 'hover:bg-tertiary-300 focus:bg-tertiary-300 active:bg-tertiary-400',
...
export const mainElStyles: Record<BaseColors, string> = {
  ...
  light: 'bg-tertiary-200 text-tertiary-700',
  dark: 'bg-tertiary-800 text-white',
};
